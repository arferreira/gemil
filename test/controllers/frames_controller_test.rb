...
class FramesControllerTest < ActionController::TestCase
  ...
  test "should create frame" do
    assert_difference('Frame.count') do
      post :create, frame: { quadroabrev: @frame.quadroabrev, quadrodesc: @frame.quadrodesc, quadrogrupo: @frame.quadrogrupo, quadroid: @frame.quadroid }
    end
  ...
  test "should update frame" do
    patch :update, id: @frame, frame: { quadroabrev: @frame.quadroabrev, quadrodesc: @frame.quadrodesc, quadrogrupo: @frame.quadrogrupo, quadroid: @frame.quadroid }
    assert_redirected_to frame_path(assigns(:frame))
  end
