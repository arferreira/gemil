...
class SpecialtiesControllerTest < ActionController::TestCase
  ...
  test "should create specialty" do
    assert_difference('Specialty.count') do
      post :create, specialty: { espabrev: @specialty.espabrev, espcodigo: @specialty.espcodigo, espdesc: @specialty.espdesc, espgrupo1: @specialty.espgrupo1, espgrupo2: @specialty.espgrupo2, espid: @specialty.espid }
    end
  ...
  test "should update specialty" do
    patch :update, id: @specialty, specialty: { espabrev: @specialty.espabrev, espcodigo: @specialty.espcodigo, espdesc: @specialty.espdesc, espgrupo1: @specialty.espgrupo1, espgrupo2: @specialty.espgrupo2, espid: @specialty.espid }
    assert_redirected_to specialty_path(assigns(:specialty))
  end
