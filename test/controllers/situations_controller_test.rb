...
class SituationsControllerTest < ActionController::TestCase
  ...
  test "should create situation" do
    assert_difference('Situation.count') do
      post :create, situation: { situacaoabrev: @situation.situacaoabrev, situacaodesc: @situation.situacaodesc, situacaoid: @situation.situacaoid }
    end
  ...
  test "should update situation" do
    patch :update, id: @situation, situation: { situacaoabrev: @situation.situacaoabrev, situacaodesc: @situation.situacaodesc, situacaoid: @situation.situacaoid }
    assert_redirected_to situation_path(assigns(:situation))
  end
